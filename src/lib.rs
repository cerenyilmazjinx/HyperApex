...
#[derive(Debug)]
pub struct HyperApexProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HyperApexProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HyperApex processing");
    
    let mut processor = HyperApexProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HyperApexProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HyperApexProcessor::new(false);
